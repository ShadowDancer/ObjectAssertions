...
namespace ObjectAssertions.Generator.Tests
{
    public class GeneratorTests
    {
        ...
        [Fact]
        public void TestRecordAssertions_ExecutesAllAssertions()
        {
            var executedAssertions = new List<string>();
        ...
        [Fact]
        public void NestedTestRecordAssertions_ExecutesAllAssertions()
        {
            var executedAssertions = new List<string>();
            var testObject = new NestedTestRecord();

            var assertions = new NestedTestRecordAssertions(testObject)
            {
                Name = n => executedAssertions.Add("Name"),
                Nested = n => executedAssertions.Add("Nested")
            };
